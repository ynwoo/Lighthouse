...
public interface StudyRepository extends JpaRepository<Study, Long>, StudyRepositoryCustom {
    // 상세 정보 조회 (상세정보)
    @EntityGraph(attributePaths = {"original", "sido", "gugun", "studyTags", "studyEvals", "studyNotices", "sessions", "qnas", "participations"})
    Optional<Study> findDetailById(@Param("studyId") Long studyId);

    // 상세 정보 조회 (복제)
    @EntityGraph(attributePaths = {"sido", "gugun", "studyTags", "studyNotices", "sessions"})
